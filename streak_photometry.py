...
def streak_photometry(image_data, expnum=None,
    ...
    # Use 3 sigma instead of FWHM for width of area
    area_width = 3 * sigma_fit
    area_arcsec2 = trail_length_pix * area_width * pixel_scale**2
    ...
    if make_plots: 
        ...
        plt.tight_layout()
        plt.savefig("masked_pixels.pdf", bbox_inches='tight')
        plt.show()
        ...
        plt.savefig("streak_profile.pdf", bbox_inches='tight')
        plt.tight_layout()
        plt.show()
...
def streak_photometry_psf_fitting (image_data,
    ...
    # Use 3 sigma instead of FWHM for width of area
    area_width = 3 * sigma_fit * pixel_scale
    area_arcsec2 = L_fit * pixel_scale * area_width
